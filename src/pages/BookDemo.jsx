    ...
    <Layout>
      <div className="w-full h-auto">
        <div className="w-full relative">
          ...
          <div className="w-[90%] lg:w-[80%] max-w-[1535px]  min-h-[300px] h-auto flex flex-col-reverse lg:flex-row shadow-lg overflow-hidden rounded-[14px]  absolute top-[135px] lg:top-[165px] mx-auto left-0 right-0  z-10">
            <BookDemoForm />
            <BookDemoInfo />
          </div>
        </div>
