...
const HeroSection = () => {
  return (
    <div className="w-full max-w-[1535px] mx-auto h-auto flex flex-col-reverse lg:flex-row items-center pb-[60px]">
      <div className="w-[100%] lg:w-[50%] pl-[15px] sm:pl-[40px] lg:pl-[100px] xl:pl-[150px]">
        <div className="w-full flex pt-[40px] lg:pt-[85.92px]">
          <div className="w-full">
            ...
            <h1 className="text-[24px] lg:text-[38px] font-[600] leading-[30px] lg:leading-[46px]">
              Make Your{" "}
              <span className="text-[#FF7301]">workplace awesome</span>
            </h1>
            <h1 className="text-[24px] lg:text-[38px] font-[600] leading-[30px] lg:leading-[46px]">
              with <span className="text-[#FF7301]">Employee Engagement!</span>
            </h1>
            <p className="w-full sm:w-[90%] lg:w-[70%] mt-[16px] text-justify font-[400] text-[16px] lg:text-[24px] leading-[26px] lg:leading-[30px] text-[#092B59]">
              Empower your workforce for an ever-changing landscape with
              Inimble's dynamic features. Adapt, evolve, and excel effortlessly.
            </p>
            <div className="mt-7 flex gap-5 justify-between md:justify-start">
              <input
      ...
      {/* -------------right content-------------- */}
      <div className="w-[100%] lg:w-[50%] h-[270px] lg:h-[400px] relative">
        <div className="w-full pl-4 lg:pl-0 lg:flex lg:justify-end  absolute right-[-65px] top-[-15px] lg:top-[-85px] lg:right-[-148px]">
          <img src={heroImg2} alt="img" className="lg:w-[100%] bg-cover" />
        </div>
      </div>
    </div>
  );
