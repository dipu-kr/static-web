    ...
    <div className="flex-1">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          <span className="font-[400] leading-[40px] text-[18px] text-[#000000]">
            Call
          </span>
          <p className="flex items-center gap-2">
            ...
            <span className="text-[16px] font-[400] leading-[24px] text-[#000000]">
              +91 8328 211 174
            </span>
          </p>
        </div>
        ...
        <div className="flex flex-col gap-1 mt-5">
          <label className="font-[400] leading-[40px] text-[18px] text-[#000000]">
            Map View
          </label>
          <div>
