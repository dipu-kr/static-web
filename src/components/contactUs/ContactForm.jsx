      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            className="w-[90%] resize-none rounded-[8px] text-[16px] font-[400] text-[#1F1F1F] placeholder:text-[#1F1F1F] pl-4 pt-3 border border-gray-300 outline-none hover:ring"
          />
        </div>
