      ...
      <div className="w-full h-full bookDemoInfoBgImg rounded-[14px] lg:rounded-r-[14px]">
        <div className="h-full flex flex-col justify-around px-[10px] py-[20px] lg:p-8">
          <div>
            ...
            <p className="text-[15px] lg:text-[24px] font-[400] text-[#F3F3F3] leading-[29px]">
          ...
          <div className="grid grid-cols-3 gap-8 mt-[30px] lg:mt-0">
            <div>
              <img src={tab4} className="w-[64px] object-cover" alt="Icon" />
              <p className="flex items-center gap-1">
                <span className="text-[15px] lg:text-[18px] font-[400] leading-[31px]">
                  Engage
                </span>
                <span className="pb-2">
                  <HiPlus />
