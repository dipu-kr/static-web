...
const Footer = () => {
  ...
  return (
    <div className="bg-[#1F1F1F]">
      <footer className="w-full max-w-[1535px] mx-auto min-h-[400px] h-auto px-50px md:px-30px lg:px-[100px] py-10 flex justify-center items-center flex-col gap-10 bg-[#1F1F1F] text-white tracking-wide">
